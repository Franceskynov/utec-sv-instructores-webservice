...
<head>
    ...
    <title> Notificaci&oacute;n de nuevo usuario </title>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="750" class="table750" style="width: 100%; max-width: 750px; min-width: 340px; background: #f5f8fa;">
                <tr>
                    ...
                    <td align="center" valign="top" style="background: #ffffff;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="65%" style="width: 65% !important; min-width: 270px; max-width: 65%; border-width: 1px; border-style: solid; border-color: #e5e5e5; border-radius: 5px;">
                            <tr>
                                ...
                                <td align="center" valign="top">
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 19px; line-height: 25px; font-weight: 600; text-decoration: none;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 19px; line-height: 25px; font-weight: 600; text-decoration: none;"> {{ $email }} </span>
                                    </font>
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#5E5E5E" style="font-size: 19px; line-height: 22px; text-decoration: none;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #5E5E5E; font-size: 19px; line-height: 22px; text-decoration: none;"> {{ $password }} </span>
                                    </font>
                                    <div style="height: 40px; line-height: 40px; font-size: 38px;">&nbsp;</div>
                                ...
                                <td align="center" valign="top">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                                        <tr>
                                            <td align="center" valign="top">
                                                ...
                                                <font face="'Source Sans Pro', sans-serif" color="#868686" style="font-size: 17px; line-height: 20px;">
                                                    <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 17px; line-height: 20px;">Copyright &copy; 2019 Universidad Tecnol&oacute;gica de El Salvador. Todos los derechos reservados</span>
                                                </font>
                                       ...
                                       <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px;">
                                          <a href="mailto:contactanos@utec.edu.sv" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">contactanos@utec.edu.sv</a> &nbsp;&nbsp;|&nbsp;&nbsp;
                                          <a href="tel:50322758888 " target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">503 2275-8888</a> &nbsp;&nbsp;|&nbsp;&nbsp;
                                          <a href="https://www.utec.edu.sv" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">www.utec.edu.sv</a></span>
                                                </font>
