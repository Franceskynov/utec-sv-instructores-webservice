                            ...
                            <tr>
                                ...
                                <td align="center" valign="top">
                                    ...
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #7d0634; border-radius: 4px;">
                                        <tr>
                                            <td align="center" valign="top">
                                                <a href="{{ $data['url'] }} " target="_blank" style="display: block; border: 1px solid #7d0634; border-radius: 4px; padding: 19px 27px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 26px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
